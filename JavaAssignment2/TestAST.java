...
public class TestAST extends TestCase {
    ...
    public void testToStringCombined() {
      ...
      assertEquals("(1 + 2) * 2 * 3", mult1.toString());
      assertEquals("(2 + 3) / (2 + 3)", div.toString());
      assertEquals("(2 + 3 + 3) * (-(1.0) - log(1.0))", mult2.toString());
    }
         //equals
    @Test
    ...
    public void testEqualsCombined(){
      ...
      Subtraction sub = new Subtraction(neg,log);
      Multiplication mult2 = new Multiplication(add2,sub);
      assertTrue(mult1.equals(new Multiplication(new Multiplication(newAddition(new Constant(1), new Constant(2)),new Constant(2)),new Constant(3));
      assertTrue(div.equals(new Division(new Addition(new Constant(2), new Constant(3)), new Addtion(new Constant(2), new Constant(3))));
    ...
    public void testEvalCombined(){
      ...
      Multiplication mult = new Multiplication(add,c2);
      Multiplication mult1 = new Multiplication(mult,c3);
      Division div = new Division(add1,add);
      Log log = new Log(c1);
      Negation neg = new Negation(c1);
      Subtraction sub = new Subtraction(neg,log);
      Multiplication mult2 = new Multiplication(add2,sub);
      Environment env = new Environment();
      assertEquals("18.0", mult1.eval(env).toString());
      assertEquals("1.0", div.eval(env).toString());
      assertEquals("-(8.0)", mult2.eval(env).toString());
    }
}
